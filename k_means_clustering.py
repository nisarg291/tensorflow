...
# it return all rows particular which row is into which cluster 
y_kmeans = kmeans.fit_predict(X)
print(y_kmeans)
# Visualising the clusters
# X[y_kmeans == 0, 0] is value of anuual income of which is in cluster no.1
# s is for size and c for coluor

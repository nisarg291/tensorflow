...
# this axis fun. is determine range of x and y axis means hear x axis display the value between 0 to 6 and on y axis this range s from 0 to 20
plt.axis([0, 6, 0, 20])
plt.show()
...
# here 1 is no. of row and 3 is no. colum and 1 is for first subplot in frist figure
plt.subplot(131)
plt.bar(names, values)
# here 1 is no. of row and 3 is no. colum and 2 is for second subplot in frist figure
plt.subplot(132)
plt.scatter(names, values)
# here 1 is no. of row and 3 is no. colum and 3 is for third subplot in frist figure
plt.subplot(133)
...
plt.figure()
# first subplot in first figure
# here 2 is no. of row and 1 is no. colum and 1 is for first subplot in frist figure
plt.subplot(211)
plt.plot(t1, f(t1), 'bo', t2, f(t2), 'k')
#  second subplot in first figure
plt.subplot(212)
...
# it display the text which written in 3rd arg. and first two args are x and y value at which place you want to display this text
# in this, text is started from x value 60 and y value 0.025
...
# it display local max text and draw one arrow which pointing at (2,1) x axis value is 2 and y axis value is 1
# and local max is display at location of xytext=(3,1.5) 3 is value of x and 1.5 at y axis
# and value of shrink is the 0.05 value difference at x axis btw arrow and text
